...
2 - Informe a estatística descritiva (valor mínimo, máximo, mídia e desvio-padrão) das seguintes variáveis do banco: *bur_escol_2008, bur_terc_2008, rec_orcamento_2008, iqb_pcr_2008, cand_age_2008 e cand_sex_2008*
...
### 1. Gráfico de barra
Primeiro vamos fazer um gr?fico de barra com a m?dia do Indicador de Qualidade da Burocracia Municipal (IQBM) por estado da federação. Temos uma base de dados dos municípios, então devemos calcular a mídia do IQBM de cada estado com base nos valores de seus respectivos municípios:
