...
2 - Informe a estatística descritiva (valor mínimo, máximo, média e desvio-padrão) das seguintes variáveis do banco: *bur_escol_2008, bur_terc_2008, rec_orcamento_2008, iqb_pcr_2008, cand_age_2008 e cand_sex_2008*
...
Agora vamos trabalhar com a visualização gráfica de algumas informações relevantes.

### 1. Gráfico de barra
Primeiro vamos fazer um gráfico de barra com a média do Indicador de Qualidade da Burocracia Municipal (IQBM) por estado da federação. Temos uma base de dados dos municípios, então devemos calcular a média do IQBM de cada estado com base nos valores de seus respectivos municípios:
...
Podemos ainda evoluir a visualização do gráfico. Vamos dar uma olhada nas possibilidades que o R dispõe:
