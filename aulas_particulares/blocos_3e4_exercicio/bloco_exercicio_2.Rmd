...
Vamos executar uma análise de regressão de uma pesquisa sobre a qualidade da burocracia de municípios brasileiros. Nesta pesquisa foi desenvolvido o Índice de Qualidade da Burocracia (IQB)
...
Podemos ainda evoluir a visualização do gráfico. Vamos dar uma olhada nas possibilidades:
