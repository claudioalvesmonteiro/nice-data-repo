...
# retirar primeiros 10 casos de situacao e atribuir a situacao
situacao <- situacao[-c(1:10),]

```

## 2.**Manipulando Dados com Condicionais**

As vezes você quer ir além de simplesmente selecionar uma coluna ou linha especifica. Você pode querer selecionar apenas os casos de acidentes em que houve vítima, os que envolveram ciclistasm, ou ainda os que envolveram moto ou caminhão e deixaram vítima. Para tal podemos trabalhar com operações lógicas utilizando as informações que aprendemos até agora. Vejamos os exemplos abaixo:
