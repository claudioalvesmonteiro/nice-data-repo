...
acid_transit_ciclista2016 <- acid_transit_ciclista2016[complete.cases(acid_transit_ciclista2016$ciclista),]
...
ggplot(data = bairro_acid_ciclista2,  aes(x = Var1, y = Freq ) ) +    
       geom_col(fill = "black") +  # definir preenchimento das barras
